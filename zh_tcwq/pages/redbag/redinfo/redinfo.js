...
Page({
    ...
    _defineProperty(_data, "share", !1), _defineProperty(_data, "share_red", !1), _defineProperty(_data, "hydl", !1), 
    _data),
                    ...
                    success: function(e) {
                        console.log(e), e.authSetting["scope.userInfo"] ? wx.getUserInfo({
                            success: function(e) {
                                ...
                                var a = e.userInfo.nickName, o = e.userInfo.avatarUrl;
                                app.util.request({
    ...
    onLoad: function(e) {
        console.log(e, wx.getStorageSync("users"));
        var t = this;
        ...
        }), e.iszf ? (console.log("存在"), this.getuserinfo()) : (t.setData({
            user_id: wx.getStorageSync("users").id,
            name: wx.getStorageSync("users").name
        }), t.reload(), console.log("不存在"));
    },
    reload: function(e) {
    ...
    onShareAppMessage: function(e) {
        ...
        return "button" == e.from ? {
            title: a,
            path: "/zh_tcwq/pages/redbag/redinfo/redinfo?store_id=" + o.data.store_id + "&iszf=1",
