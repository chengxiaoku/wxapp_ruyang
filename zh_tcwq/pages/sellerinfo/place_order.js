...
Page({
    ...
    add: function(t) {
        var e = this, a = e.data.num + 1, o = e.data.cost1, n = (o *= a.toFixed(2)) + e.data.freight;
        e.setData({
            num: a,
            cost: o,
            cost2: n
    ...
    order: function(t) {
        ...
        console.log(u), console.log(String(g)), d = null == d ? "" : e.data.note, "" != s.user_name || this.data.dnzt ? (console.log(d), 
        app.util.request({
