...
Page({
                    ...
                    success: function(t) {
                        console.log(t), t.authSetting["scope.userInfo"] ? wx.getUserInfo({
                            success: function(t) {
                                ...
                                var s = t.userInfo.nickName, o = t.userInfo.avatarUrl;
                                n.setData({
                                    user_name: s
                                ...
                                console.log(t.userInfo.avatarUrl), app.util.request({
                                    ...
                                    success: function(t) {
                                        ...
                                        var i = t.data.openid;
                                        console.log("这是用户的openid"), console.log(i), app.util.request({
    ...
    reload: function(t) {
        var n = this, r = n.data.star1, c = n.data.star;
        app.util.request({
            ...
            success: function(t) {
                ...
                0 == (a = parseInt(a)) ? t.data.star3 = n.data.star1 : 1 == a ? t.data.star3[0].img = i : 2 == a ? (t.data.star3[0].img = i, 
                ...
                var s = t.data.store[0].details.length * n.data.size, o = wx.getSystemInfoSync().windowWidth;
                console.log(s, o), n.setData({
                    length: s,
                    windowWidth: o
                }), n.scrolltxt();
            }
    ...
    formid_two: function(t) {
        ...
        var e = this, a = e.data.index, i = e.data.value, s = e.data.id, o = wx.getStorageSync("users").id, n = e.data.reflex_id;
    ...
    onShow: function() {},
    scrolltxt: function() {
        var a = this, i = a.data.length, s = a.data.windowWidth, o = setInterval(function() {
            var t = i + s, e = a.data.marqueeDistance;
            e < t ? a.setData({
                marqueeDistance: e + a.data.marqueePace
            }) : (a.setData({
                marqueeDistance: 0
            }), clearInterval(o), a.scrolltxt());
        }, a.data.interval);
    },
    onHide: function() {},
    onUnload: function() {},
