...
Page({
  ...
  bindPickerChange: function (a) {
    ...
    console.log(t.data.nav[t.data.index]), wx.navigateTo({
      url: "../sjedit/sjedit?info=" + o + "&id=" + e + "&type_id=" + d + "&money=" + c + "&type2_id=" + r
    });
  },
  edit: function (a) {
    var t = this;
          ...
          success: function (a) {
            console.log(a), 0 != a.data.length ? (a.data.map(function (a) {
              ...
              money: o
                ...
                url: "../sjedit/sjedit?id=" + t.data.id + "&type_id=" + n + "&money=" + o + "&type2_id=0"
            });
          }
        });
      }
  ...
  selected: function (a) {
    ...
    t.setData({
      ...
      url: "../sjedit/sjedit?type2_id=" + i + "&type_id=" + o + "&money=" + r + "&info=" + d
    });
  },
  onReady: function () { },
  onShow: function () { },
